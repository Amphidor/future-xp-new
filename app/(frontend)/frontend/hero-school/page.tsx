  ...
  return (
    <section
      className="
        ...
        bg-cover bg-center
      "
      style={{ backgroundImage: "url(/frontend/bg-school.png)" }}
    >
      {/* Overlay */}
      ...
      >
        <h1
          className="
            text-[34px] md:text-[42px] lg:text-[72px] 
            font-regular text-white mt-3 sm:mt-4 md:mt-6 
            text-balance
          "
        >
          Building Skills. Inspiring Growth. <span className="block">Creating Futures.</span>
        </h1>
